            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <table class="w-full table-fixed">
                        ...
                        <tr>
                            <td class="py-4 px-6 border-b border-gray-200"><?php echo 'salam'; ?></td>
                            <td class="py-4 px-6 border-b border-gray-200 truncate"><?php echo 'salamana'; ?></td>
                            <td class="py-4 px-6 border-b border-gray-200"><?php echo 'salam' ?></td>
                            <td class="py-4 px-6 border-b border-gray-200">
                                <button class="bg-green-500 text-white py-1 px-2 rounded-full text-xs">Edit</button>
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="" method="post">
                    <div>
                        ...
                        <input type="text" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Name" required>
                    </div>
