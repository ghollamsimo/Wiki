...
<div class="relative text-white mt-16 bg-[#1A1A40]">
    <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-[#1A1A40]" preserveAspectRatio="none"
         viewBox="0 0 1440 54">
        ...
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div class="md:max-w-md lg:col-span-2">
                <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">Wiki</span>
                </a>
