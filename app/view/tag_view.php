            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <div class="mt-8 mb-3 flex justify-between">
                        <h1>Add Category</h1>
                        <button data-modal-target="tag-modal" type="button" data-modal-toggle="tag-modal" class="bg-blue-700 p-3 rounded-md">Add New Category</button>
                    </div>
                                        ...
                                        <div class="p-4 md:p-5">
                                            <form class="space-y-4" action="" method="post">
                                                <div>
                                                    ...
                                                    <input type="text" name="editname" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required>
                                                </div>
                                                <input type="hidden" name="idtag" value="<?= $tag->getIdTag() ?>">
                                                <button type="submit" name="edit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
